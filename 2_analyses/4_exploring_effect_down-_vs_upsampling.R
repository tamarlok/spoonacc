...
sensitivity.stand4.nsim <- matrix(NA, nrow=nsim, ncol=length(behaviour.labels), dimnames = list(1:nsim, behaviour.labels))
precision.stand4.nsim <- matrix(NA, nrow=nsim, ncol=length(behaviour.labels), dimnames = list(1:nsim, behaviour.labels))
deviation.intakerate.stand4.nsim <- rep(NA,nsim)
confusion.mat.stand4.nsim <- array(NA, c(length(behaviour.labels),length(behaviour.labels), nsim), dimnames = list(behaviour.labels, behaviour.labels, 1:nsim))
...
sensitivity.stand4.search5.nsim <- matrix(NA, nrow=nsim, ncol=length(behaviour.labels), dimnames = list(1:nsim, behaviour.labels))
precision.stand4.search5.nsim <- matrix(NA, nrow=nsim, ncol=length(behaviour.labels), dimnames = list(1:nsim, behaviour.labels))
deviation.intakerate.stand4.search5.nsim <- rep(NA,nsim)
confusion.mat.stand4.search5.nsim <- array(NA, c(length(behaviour.labels),length(behaviour.labels), nsim), dimnames = list(behaviour.labels, behaviour.labels, 1:nsim))
...
sensitivity.stand4.search2.nsim <- matrix(NA, nrow=nsim, ncol=length(behaviour.labels), dimnames = list(1:nsim, behaviour.labels))
precision.stand4.search2.nsim <- matrix(NA, nrow=nsim, ncol=length(behaviour.labels), dimnames = list(1:nsim, behaviour.labels))
deviation.intakerate.stand4.search2.nsim <- rep(NA,nsim)
confusion.mat.stand4.search2.nsim <- array(NA, c(length(behaviour.labels),length(behaviour.labels), nsim), dimnames = list(behaviour.labels, behaviour.labels, 1:nsim))
...
sensitivity.walk10.nsim <- matrix(NA, nrow=nsim, ncol=length(behaviour.labels), dimnames = list(1:nsim, behaviour.labels))
precision.walk10.nsim <- matrix(NA, nrow=nsim, ncol=length(behaviour.labels), dimnames = list(1:nsim, behaviour.labels))
deviation.intakerate.walk10.nsim <- rep(NA,nsim)
confusion.mat.walk10.nsim <- array(NA, c(length(behaviour.labels),length(behaviour.labels), nsim), dimnames = list(behaviour.labels, behaviour.labels, 1:nsim))
...
# what if we additionally upsample prey ingest
sensitivity.walk10.ingest6.nsim <- matrix(NA, nrow=nsim, ncol=length(behaviour.labels), dimnames = list(1:nsim, behaviour.labels))
precision.walk10.ingest6.nsim <- matrix(NA, nrow=nsim, ncol=length(behaviour.labels), dimnames = list(1:nsim, behaviour.labels))
deviation.intakerate.walk10.ingest6.nsim <- rep(NA,nsim)
confusion.mat.walk10.ingest6.nsim <- array(NA, c(length(behaviour.labels),length(behaviour.labels), nsim), dimnames = list(behaviour.labels, behaviour.labels, 1:nsim))
...
sensitivity.search2.walk10.ingest6.nsim <- matrix(NA, nrow=nsim, ncol=length(behaviour.labels), dimnames = list(1:nsim, behaviour.labels))
precision.search2.walk10.ingest6.nsim <- matrix(NA, nrow=nsim, ncol=length(behaviour.labels), dimnames = list(1:nsim, behaviour.labels))
deviation.intakerate.search2.walk10.ingest6.nsim <- rep(NA,nsim)
confusion.mat.search2.walk10.ingest6.nsim <- array(NA, c(length(behaviour.labels),length(behaviour.labels), nsim), dimnames = list(behaviour.labels, behaviour.labels, 1:nsim))
...
sensitivity.stand4.search2.drink5.handle5.walk2.soar10.nsim <- matrix(NA, nrow=nsim, ncol=length(behaviour.labels), dimnames = list(1:nsim, behaviour.labels))
precision.stand4.search2.drink5.handle5.walk2.soar10.nsim <- matrix(NA, nrow=nsim, ncol=length(behaviour.labels), dimnames = list(1:nsim, behaviour.labels))
deviation.intakerate.stand4.search2.drink5.handle5.walk2.soar10.nsim <- rep(NA,nsim)
confusion.mat.stand4.search2.drink5.handle5.walk2.soar10.nsim <- array(NA, c(length(behaviour.labels),length(behaviour.labels), nsim), dimnames = list(behaviour.labels, behaviour.labels, 1:nsim))

for (i in 1:nsim) {
  RF.model.output <- RF.model(dfs[[1]], dfs[[2]], stand=4, search=2, drink=5, handle=5, walk=2, soar=10)
